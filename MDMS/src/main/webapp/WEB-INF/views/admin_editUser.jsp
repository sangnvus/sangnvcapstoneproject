			...
			<div id="inner">
				<div id="header">
					...
					<table width="600" align="center" cellspacing="0" id="menubar">
						<tr>
							<td><a href="admin_listUser" id="font">Quản lý người
									dùng</a></td>
										...
										<tr>
											...
											<td width="25%"><select id="province" name="province">
													...
													<c:forEach var="province" items="${provinceList}">
														<c:if test="${province.getprovinceId()==user.getDistrict().getProvineId() }">
															<option value="${province.getProvinceId()}" selected="selected"><c:out
