							...
							<div style="margin-top: 10px; margin-left: 40px">
								<table border="0" width="60%" align="left">
									...
									<tr>
										...
										<td width="25%"><select id="category" name="category" disabled="disabled" class ="inputE"> 
									...
									<tr>
										...
										<td width="25%"><select id="supplier" name="supplier" disabled="disabled" class ="inputE"> 
									...
									<tr>
										...
										<td width="25%"><select id="producer" name="producer" disabled="disabled" class ="inputE">
									...
									<tr>
										...
										<td width="25%"><input width="25%" size="20"
											type="number" disabled="disabled"  class ="inputE"name="gn" value="${product.unitsInStock}"></input></td>
									</tr>
									
									<tr>
										<td width="5%">Đặt hàng</td>
										<td width="25%"><input width="25%" size="20"
											type="number"  disabled="disabled" class ="inputE" name="gn"  value="${product.unitsOnOrders}"></input></td>
									</tr>
									<tr>
										<td width="5%">Giá nhập</td>
										<td width="25%"><input width="25%" size="20"
											type="number"  disabled="disabled" class ="inputE" name="gn" value="${product.getImportPrice()}"></input>VND</td>
									</tr>

									<tr>
										<td width="5%">Giá xuất</td>
										<td width="25%"><input width="25%" size="20"
											type="number" disabled="disabled" class ="inputE" name="gx" value="${product.getExportPrice()}"></input>VND</td>
									</tr>

									<tr>
										<td width="8%">Mô tả sản phẩm</td>
										<td width="24%"><textarea disabled="disabled" class ="inputE" name="mtsp"
